...
# Data
parser.add_argument('--train_size', default=1000, type=int, help='Training data size')#1000000
...
# Train
parser.add_argument('--nof_epoch', default=5, type=int, help='Number of epochs')#50000
...
def main():
    for epoch in range(params.nof_epoch):
        ...
        for i_batch, sample_batched in enumerate(iterator):
            ...
            iterator.set_postfix(loss='{}'.format(loss.tolist()))
